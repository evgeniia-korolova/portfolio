const renderProjects = (data, containerSelector) => {
    ...
    data.forEach((project, index) => {        
        ...
        const cardHtml = `
            <div class="card card-animate" style="animation-delay: ${index * 0.1}s" data-id="${project.id}">
                ...
                <div class="actions-wrapper">
                    ...
                    <div class="card-buttons">
                        <a href="${project.links.code}" class="project-link" target="_blank">
                            <img src="./images/icons/code.svg" alt="code-icon" class="project-link-icon" />
                            <span class="project-link-text">Code</span>
                        </a>
                        <a href="${project.links.demo}" class="project-link" target="_blank">
                            <img src="./images/icons/demo.svg" alt="demo-svg" class="project-link-icon" />
